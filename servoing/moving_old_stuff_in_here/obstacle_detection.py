...
def visualize_points(lidar_points):
    ...
    # visualize the obstacles in the way
    print()
    print("----------------------------------------------------------------------------------------------------")
    string = " "
    for i in range(len(lidar_points)):
    ...
    print()
'''
Use this function if I am passing in a list that has the three rows
'''
    ...
    for i in range(len(lidar_points)):
        for j in range(len(lidar_points[0])):
            if lidar_points[i][j].get_has_index():
                ...
                cluster = Cluster(temp_start,angle, angle_two, temp_end, x_one, x_two, y_one, y_two)
